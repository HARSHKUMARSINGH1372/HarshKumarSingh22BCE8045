...
import img from "../image/monopoly-bank.png";
import "../cssForPages/join.css";
import axios from "axios";

export default function Join_Game() {
  const { game_Id, set_game_Id, currentGameId, setCurrentGameId } =
    useContext(Data);
  ...
  useEffect(() => {
    axios
      .get("https://monopoly-backend-8omq.onrender.com/players/start_server")
      .then((res) => {
    ...
    <>
      <div>
        <div className="loader">
          <p className="text">Monopoly Bank</p>
        </div>
      </div>
      ...
      <div className="enter-game">
        <div className="input-container">
          ...
          <br />
          <div className="handle-buttons-join">
            <button className="cssbuttons-io-button" onClick={join_Game}>
              Start Game
              <div className="icon">
                <svg
                  height="24"
        ...
        <div>
          <p class="cursor typewriter-animation">
            Fortune Favors the Smart Banker!
          </p>
        </div>
      </div>
    </>
